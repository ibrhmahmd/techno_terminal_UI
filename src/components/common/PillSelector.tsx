...
export function PillSelector({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div
        className={`flex items-center gap-1 rounded-[6px] bg-slate-100 p-1 ${
        ...
        {options.map((option, index) => {
          ...
          return (
            <button
              ...
              disabled={disabled}
              className={`flex-1 px-3 py-2 rounded-[4px] font-medium text-sm transition-all flex items-center justify-center gap-2 ${
                isActive
